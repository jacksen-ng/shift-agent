...
def company_info_request(company_id:int):
    with get_session_scope() as session:
        ...
        return {
            ...
            "open_time": company_data.open_time.strftime("%H:%M:%S") if company_data.open_time else None,
            "close_time": company_data.close_time.strftime("%H:%M:%S") if company_data.close_time else None,
